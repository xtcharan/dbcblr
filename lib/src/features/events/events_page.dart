...
class _EventsPageState extends State<EventsPage> {
  ...
  final List<Event> _events = [
    Event(
      ...
      description: "Annual academic conference featuring keynote speakers from top universities.",
    ...
    Event(
      ...
      description: "Three-day cultural extravaganza featuring music, dance, drama performances.",
    ...
    Event(
      ...
      description: "Annual basketball tournament between all houses.",
    ...
    Event(
      ...
      description: "24-hour coding competition focused on developing solutions.",
    ...
    Event(
      ...
      description: "Hands-on workshop on photography basics and composition techniques.",
    ...
    Event(
      ...
      description: "Annual recruitment drive with 50+ companies.",
  ...
  Map<DateFilterType, int> get _eventCounts {
    final now = DateTime.now();
    final today = DateTime(now.year, now.month, now.day);
    final tomorrow = today.add(const Duration(days: 1));
    final weekEnd = today.add(const Duration(days: 7));
    ...
    final counts = <DateFilterType, int>{};

    for (final filterType in DateFilterType.values) {
      counts[filterType] = _events.where((event) {
        final eventDate = DateTime(
          event.startDate.year,
          event.startDate.month,
          event.startDate.day,
